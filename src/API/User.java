...
public class User {
	...
	//解析JSON
	 public static void jsonToObj_User(String jsonStr,BufferedWriter out) throws Exception {   
	     ...
	     JSONArray jsonArray = resultObject.getJSONArray("userList");
	    // System.out.println(totalCount);
	     for(int i=0;i<jsonArray.length();i++){
	    	 JSONObject user = jsonArray.getJSONObject(i);
	    	 String userId=user.optString("userId");
	    	 String  telephone=user.optString("telephone");
	    	 String sex=user.optString("sex");
	    	 String cityId=user.optString("cityId");
	    	 String cityName=user.optString("cityName");
	    	 int age=Integer.parseInt(user.optString("age"));
	    	 String userName=user.optString("userName");
		     out.write(userId+"|"+telephone+"|"+sex+"|"+cityId+"|"+cityName+"|"+age+"|"+userName+'\n');   
	     } 
	 }
 ...
 public static void writetoFile(String Filename,int PageNum,User user,String time,String sign) throws Exception{
    	 
    	 File file_user=new File(Filename);
		 BufferedWriter out_user=new BufferedWriter(new FileWriter(file_user,true));
